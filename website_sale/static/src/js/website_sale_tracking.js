eagle.define('website_sale.tracking', function (require) {
...
publicWidget.registry.websiteSaleTracking = publicWidget.Widget.extend({
    ...
    events: {
        'click form[action="/info/cart/update"] a.a-submit': '_onAddProductIntoCart',
        'click a[href="/info/checkout"]': '_onCheckoutStart',
        'click div.oe_cart a[href^="/web?redirect"][href$="/info/checkout"]': '_onCustomerSignin',
        'click form[action="/info/confirm_order"] a.a-submit': '_onOrder',
    ...
    start: function () {
        ...
        if (this.$('div.oe_website_sale_tx_status').length) {
            ...
            this._rpc({
                route: '/info/tracking_last_order/',
            }).then(function (o) {
