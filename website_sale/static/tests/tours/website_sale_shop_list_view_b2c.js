eagle.define('website_sale.tour_info_list_view_b2c', function (require) {
'use strict';

var rpc = require('web.rpc');
var tour = require('web_tour.tour');

tour.register('info_list_view_b2c', {
    test: true,
    url: '/info?search=Test Product',
},
    [
        {
