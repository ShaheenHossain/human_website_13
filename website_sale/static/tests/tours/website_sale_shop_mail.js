eagle.define('website_sale.tour_info_mail', function (require) {
'use strict';
...
tour.register('info_mail', {
    test: true,
    url: '/',
},
[
    {
        content: "Change the domain of the websites and go to info",
        trigger: 'body',
        run: function () {
            ...
            Promise.all([def1, def2]).then(function (data) {
                window.location.href = '/info?search=Acoustic Bloc Screens';
            });
        },
    },
    {
