eagle.define('website_sale_tour.tour', function (require) {
    ...
    },
    {
        ...
        run: function () {
            ...
            def2.then(function () {
                window.location.href = '/web/session/logout?redirect=/info?search=Storage Box';
            });
        },
    },
    ...
    },
    {
        ...
        trigger: '.one_kanban form[action^="/info/address"] .btn',
    },
    {
        content: "Fulfill shipping address form",
        trigger: 'select[name="country_id"]',
    ...
    },
    {
        ...
        run: function () {
            $('.oe_login_form input[name="login"]').val("admin");
            $('.oe_login_form input[name="password"]').val("admin");
            $('.oe_login_form input[name="redirect"]').val("/info/cart");
            $('.oe_login_form').submit();
        },
    },
    {
    ...
    },
    {
        ...
        run: function () {
            $('.oe_login_form input[name="login"]').val("abc@eagle.com");
            $('.oe_login_form input[name="password"]').val("1admin@admin");
            $('.oe_login_form input[name="redirect"]').val("/info?search=Storage Box");
            $('.oe_login_form').submit();
        },
    },
    {
