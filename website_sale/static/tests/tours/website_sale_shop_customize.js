eagle.define('website_sale.tour_info_customize', function (require) {
    'use strict';

    var tour = require("web_tour.tour");

    tour.register('info_customize', {
        test: true,
        url: '/info',
    },
        [
            ...
            },
            {
                ...
                run: function() {
                    ...
                    var ajax = eagle.__DEBUG__.services['web.ajax'];
