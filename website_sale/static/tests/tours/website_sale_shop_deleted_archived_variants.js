eagle.define('website_sale.tour_info_deleted_archived_variants', function (require) {
'use strict';

var tour = require('web_tour.tour');

// This tour relies on a data created from the python test.
tour.register('tour_info_deleted_archived_variants', {
    test: true,
    url: '/info?search=Test Product 2',
},
[
    {
        content: "check price on /info (template price)",
