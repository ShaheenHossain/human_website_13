eagle.define('website_sale.tour_info_zoom', function (require) {
'use strict';
...
tour.register('info_zoom', {
    test: true,
    url: '/info?search=' + imageName,
},
[
    {
    ...
    },
    {
        ...
        trigger: 'body:not(:has(.zoomeagle-flyout img))',
    },
    {
