eagle.define('website_sale.tour_info_cart_recovery', function (require) {
'use strict';
...
var orderIdKey = 'website_sale.tour_info_cart_recovery.orderId';
var recoveryLinkKey = 'website_sale.tour_info_cart_recovery.recoveryLink';

tour.register('info_cart_recovery', {
    test: true,
    url: '/info?search=Acoustic Bloc Screens',
},
[
    {
