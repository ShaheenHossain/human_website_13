...
class TestUi(eagle.tests.HttpCase):
    ...
    def test_01_admin_info_customize_tour(self):
        self.start_tour("/", 'info_customize', login="admin")

    def test_02_admin_info_custom_attribute_value_tour(self):
        ...
        self.start_tour("/", 'info_custom_attribute_value', login="admin")

    def test_03_public_tour_info_dynamic_variants(self):
        ...
        self.start_tour("/", 'tour_info_dynamic_variants')
    ...
    def test_04_portal_tour_deleted_archived_variants(self):
        ...
        self.start_tour("/", 'tour_info_deleted_archived_variants', login="portal")
    ...
    def test_05_demo_tour_no_variant_attribute(self):
        ...
        self.start_tour("/", 'tour_info_no_variant_attribute', login="demo")

    def test_06_admin_list_view_b2c(self):
        self.start_tour("/", 'info_list_view_b2c', login="admin")
