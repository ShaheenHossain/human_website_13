...
from eagle.addons.website.tools import MockRequest


@eagle.tests.tagged('post_install', '-at_install')
class TestUi(eagle.tests.HttpCase):
    def test_01_admin_info_tour(self):
        self.start_tour("/", 'info', login="admin")

    def test_02_admin_checkout(self):
        self.start_tour("/", 'info_buy_product', login="admin")

    def test_03_demo_checkout(self):
        self.start_tour("/", 'info_buy_product', login="demo")
