...
from eagle.addons.sale.controllers.variant import VariantController
...
class WebsiteSaleVariantController(VariantController):
    ...
    def get_combination_info_website(self, product_template_id, product_id, combination, add_qty, **kw):
        ...
        carousel_view = request.env['ir.ui.view'].render_template('website_sale.info_product_carousel',
            values={
