...
class Website(models.Model):
    ...
    pricelist_id = fields.Many2one('product.pricelist', compute='_compute_pricelist_id', string='Default List')
    ...
    pricelist_ids = fields.One2many('product.pricelist', compute="_compute_pricelist_ids",
                                    string='list available for this Ecommerce/Website')
    all_pricelist_ids = fields.One2many('product.pricelist', 'website_id', string='All lists',
    ...
    info_ppg = fields.Integer(default=20, string="Number in the grid on the info")
    info_ppr = fields.Integer(default=4, string="Number of grid columns on the info")
